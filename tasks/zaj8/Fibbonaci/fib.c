...
static unsigned int __pyx_f_3fib_fib(unsigned int, int __pyx_skip_dispatch); /*proto*/
#define __Pyx_MODULE_NAME "fib"
int __pyx_module_is_main_fib = 0;

/* Implementation of 'fib' */
static PyObject *__pyx_pf_3fib_fib(CYTHON_UNUSED PyObject *__pyx_self, unsigned int __pyx_v_n); /* proto */
...
static unsigned int __pyx_f_3fib_fib(unsigned int __pyx_v_n, CYTHON_UNUSED int __pyx_skip_dispatch) {
 ...
 *     return fib(n-1) + fib(n-2)             # <<<<<<<<<<<<<<
 */
  __pyx_r = (__pyx_f_3fib_fib((__pyx_v_n - 1), 0) + __pyx_f_3fib_fib((__pyx_v_n - 2), 0));
  goto __pyx_L0;
...
static PyObject *__pyx_pw_3fib_1fib(PyObject *__pyx_self, PyObject *__pyx_arg_n) {
  ...
  assert(__pyx_arg_n); {
    __pyx_v_n = __Pyx_PyInt_As_unsigned_int(__pyx_arg_n); if (unlikely((__pyx_v_n == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  ...
  __pyx_r = __pyx_pf_3fib_fib(__pyx_self, ((unsigned int)__pyx_v_n));
...
static PyObject *__pyx_pf_3fib_fib(CYTHON_UNUSED PyObject *__pyx_self, unsigned int __pyx_v_n) {
  ...
  __pyx_t_1 = __Pyx_PyInt_From_unsigned_int(__pyx_f_3fib_fib(__pyx_v_n, 0)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyMethodDef __pyx_methods[] = {
  {"fib", (PyCFunction)__pyx_pw_3fib_1fib, METH_O, 0},
  {0, 0, 0, 0}
};
